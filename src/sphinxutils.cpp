//
// $Id: sphinxutils.cpp 1212 2008-03-13 13:38:36Z shodan $
//
...
ISphTokenizer * sphConfTokenizer ( const CSphConfigSection & hIndex, CSphString & sError )
{
	...
	{
		//LMN: TODO append GBKTokenizer here.
		pTokenizer = sphCreateUTF8ChineseTokenizer(hIndex["charset_dictpath"].cstr());

	} 
#if USE_LIBICONV
	else if ( hIndex("charset_dictpath") &&hIndex["charset_type"]=="zh_cn.gbk")
	{
		pTokenizer = sphCreateGBKChineseTokenizer(hIndex["charset_dictpath"].cstr());
	} 
#endif
