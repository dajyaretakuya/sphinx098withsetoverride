//
// $Id: sphinx.h 1198 2008-03-06 03:00:45Z shodan $
//
...
/////////////////////////////////////////////////////////////////////////////
	...
	#define USE_MMSEG		1	/// whether to compile iconv support
#else
...
#define SPHINX_VERSION			"0.9.8" SPHINX_BITS_TAG "-rc2 (" SPH_SVN_TAGREV ")"
...
public:
	...
	{ 
		sphSetRowAttr(m_pRowitems, tLoc, uValue); 
	}
	...
	{ 
		sphSetRowAttr(m_pRowitems, tLoc, sphF2DW(fValue)); 
	}
};
